...
export declare const STATUS_NEW = "new";
/** Application is stopped, no containers are active */
export declare const STATUS_STOPPED = "stopped";
/** Application is running */
export declare const STATUS_RUNNING = "running";
/** Application has crashed */
export declare const STATUS_CRASHED = "crashed";
/** Application is restarting */
export declare const STATUS_RESTARTING = "restarting";
/** Application is changing the container formation */
export declare const STATUS_SCALING = "scaling";
/** Application is starting up */
export declare const STATUS_BOOTING = "booting";
export declare type AppStatus = typeof STATUS_NEW | typeof STATUS_STOPPED | typeof STATUS_RUNNING | typeof STATUS_CRASHED | typeof STATUS_RESTARTING | typeof STATUS_SCALING | typeof STATUS_BOOTING;
