...
export class SCMRepoLinks {
     ...
     */
    find(appID) {
        return unpackData(this._client.apiClient().get(`/apps/${appID}/scm_repo_link`), "scm_repo_link");
    }
    /**
    ...
    create(appID, opts) {
        return unpackData(this._client
            .apiClient()
            .post(`/apps/${appID}/scm_repo_link`, { scm_repo_link: opts }), "scm_repo_link");
    }
    /**
    ...
    update(appID, opts) {
        return unpackData(this._client
            .apiClient()
            .patch(`/apps/${appID}/scm_repo_link`, { scm_repo_link: opts }), "scm_repo_link");
    }
    /**
     ...
     */
    destroy(appID) {
        return unpackData(this._client.apiClient().delete(`/apps/${appID}/scm_repo_link`));
    }
    /**
     ...
     */
    branches(appID) {
        return unpackData(this._client.apiClient().get(`/apps/${appID}/scm_repo_link/branches`), "branches");
    }
    /**
     ...
     */
    pulls(appID) {
        return unpackData(this._client.apiClient().get(`/apps/${appID}/scm_repo_link/pulls`), "pulls");
    }
    /**
     ...
     */
    reviewApps(appID) {
        return unpackData(this._client.apiClient().get(`/apps/${appID}/scm_repo_link/review_apps`), "review_apps");
    }
}
