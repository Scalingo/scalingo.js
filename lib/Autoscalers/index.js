...
export default class Autoscalers {
     ...
     */
    for(appId) {
        return unpackData(this._client.apiClient().get(`/apps/${appId}/autoscalers`), "autoscalers");
    }
    /**
     ...
     */
    create(appId, autoscaler) {
        return unpackData(this._client
            .apiClient()
            .post(`/apps/${appId}/autoscalers`, { autoscaler: autoscaler }), "autoscaler");
    }
    /**
     ...
     */
    show(appId, autoscalerId) {
        return unpackData(this._client
            .apiClient()
            .get(`/apps/${appId}/autoscalers/${autoscalerId}`), "autoscaler");
    }
    /**
     ...
     */
    update(appId, autoscalerId, autoscaler) {
        return unpackData(this._client
            .apiClient()
